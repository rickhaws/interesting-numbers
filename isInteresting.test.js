...
describe('Basic inputs', function() {
  it('should pass all conditions', function() {
    ...
    Test.assertEquals(isInteresting(898, [10000012]), 2);
    ...
    Test.assertEquals(isInteresting(23456, [1337, 31415, 314159, 24680]), 2);
    Test.assertEquals(isInteresting(543210, [1337, 31415, 314159, 24680]), 2);
